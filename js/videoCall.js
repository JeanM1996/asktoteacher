...
function startCall() {
    ...
    nameNode.style.backgroundColor = "black"
    nameNode.style.height = "20px"
    nameNode.style.padding = "5px"
    nameNode.style.textAlign = "left"
    nameNode.style.color = "white"
    ...
    let sessionName = localStorage.getItem("channelName");
    let welcomeMsg1 = document.createTextNode(sessionName.toUpperCase() + " SESSION")
    let welcomeBox2 = document.createElement("div")
    let welcomeMsg2 = document.createTextNode("<ONLINE>")
...
let videoIcon = document.getElementById("videoStop");
